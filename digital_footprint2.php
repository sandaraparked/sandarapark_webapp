...
<head>
    ...
    <title>RESPARKMAN - Digital footprint</title>
            ...
            <div class="container2">
                <div class="forms">
                    <div class="form-content">
                        ...
                        <form action="includes/digital_footprint.inc.php" method="POST">
                        <div class="input-container">
                            <label for="date1">Date (from):</label>
                            <input class="datepicker form-control" type="text" id="date1" name="date1" value="<?=$_SESSION["date1"]?>">
                        </div>                
                        <div class="input-container">
                            <label for="date2">Date (to):</label>
                            <input class="datepicker form-control" type="text" id="date2" name="date2" value="<?=$_SESSION["date2"]?>" >
                        </div>
                        <div class="input-container">
                            <label for="time1"> Time of access (from):</label>
                            <input class="form-control timepicker" type="text" id="time1" name="time1" value="<?=$_SESSION["time1"]?>">
                        </div>
                        <div class="input-container">
                            <label for="time2">Time of access (to):</label>
                        ...
                        <div class="input-container">
                            <a class="add-btn link-light nounderline" href="includes/df_export_data.inc.php">Export Data</a>
                        </div>
                        </form>
                            ...
                            <table class="styled-table">
                                <thread>
                                    <tr>
                                        ...
                                        <th>Action done</th>
                                        <th>Date accessed <br>(YYY-MM-dd)</th>
                                        <th>Time accessed (24:00:00)</th>
                                    </tr>
                                </thread>
                                <tbody>
                                    <?php
                                    require_once 'includes/digital_footprint.inc.php';
                                    while($row = mysqli_fetch_assoc($result)){

                                        ?>
                                        <tr>
                                        <td><?= $row["record_id"] ?></td>
                                        <td><?= $row["accessed_by"] ?></td>
                                        <td><?= $row["accessed_table"] ?></td>
                        ...
                        <div class="container4">
                            ...
                            for ($page=1;$page<=$number_of_pages;$page++) {
                                echo '<a href="digital_footprint2.php?page=' . $page . '">' . $page . '</a> ';
                            }
                            ?>
                            </div>
                        </div>
