...
{
    header("location:reserve_exp1_security.php");
    exit();
}
...
<head>
    ...
    <title>IRTC Parking Management</title>
            ...
            <div class="container-p">
                <div class="forms">
                    <div class="form-content">
                        ...
                        <div class="nxt-b">
                            <a class="btn btn-outline-primary" href="reserve_exp2_admin.php" role="button">Next</a>
                        </div>
                        <br>
                        <?php 
                        include('message.php');
                            ...
                            <ul class="showcase2">
                                ...
                                <div class="row1">
                                    <?PHP
                                        ...
                                        echo "
                                            <div class='seat $row[availability]'><a href='edit_parking_spot1.php?parking_id=$row[parking_id]'>$row[spot]</a></div>
                                            ";
                                        }
                                    ?>
                                </div>
