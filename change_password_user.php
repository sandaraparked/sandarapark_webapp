...
<head>
    ...
    <title>RESPARKMAN - Change Password User</title>
                ...
                <?php
                    ...
                    if (isset($_GET["error"])) {
                        ...
                        elseif ($_GET["error"] == "incorrectpassword") {
                            echo "<p class='warning_msg'>the old/current password you enter is incorrect!</p>";
                        }
                ...
                <form action="includes/change_password.inc.php" method="POST">
                    ...
                    <div class="col-md-3">
                        <div class="button input-box">
                            <input type="submit" name="change_password-user" value="Change Password">
                        </div>
                    </div>
                </form>
            </div>
