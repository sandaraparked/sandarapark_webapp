...
<head>
    ...
    <title>RESPARKMAN - Edit Admin Profile Information</title>
    ...
    <div class="container2">
        <div class="forms">
            <div class="form-content">
                ...
                <form action="includes/edit_profile_admin.inc.php" method="POST">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="button input-box">
                                            <input type="submit" name="update_profile-admin" value="Update Profile">
                                        </div>
                                    </div>
                </div>
            </div>
