...
include ("includes/dbhed.inc.php");
...
<head>
    ...
    <title>RESPARKMAN - Edit IRTC Parking Spot</title>
    ...
    <div class="container2">
        <div class="forms">
            <div class="form-content">
                <div class="title">
                    Edit Parking Spot (IRTC Building)
                </div>
                <p class="warning_msg">
                    <?php
                    error_reporting(0);
                ...
                <div class="input-boxes1">
                    ...
                    if(isset($_GET['parking_id']))
                    {
                        ...
                        $parking_spot1 = "SELECT * FROM parking_spot1 WHERE parking_id='$parking_id' ";
                        ...
                        if(mysqli_num_rows($parking_spot1_run) > 0)
                        {
                            ...
                            {
                                ?>
                                <form action="includes/parking_spot1.inc.php" method="POST">
