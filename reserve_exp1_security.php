...
<head>
    ...
    <title>RESPARKMAN - IRTC Parking (Security)</title>
    ...
    <!-- jquery for auto refreshing a div content -->
    <script
            ...
            <div class="container-p">
                <div class="forms">
                    <div class="form-content">
                        ...
                        <div class="subheader"> Monitor a parking area </div>
                        <div class="nxt-b">
                            <a class="btn btn-outline-primary" href="reserve_exp2_security.php" role="button">Next</a>
                        </div>
                        <br>
                        <br>
                            ...
                            <ul class="showcase2">
                                ...
                                <div class="row1">
                                    <?PHP
                                        ...
                                        echo "
                                            <div class='seat $row[availability]'><a href='#.php?parking_id=$row[parking_id]'>$row[spot]</a></div>
                                            ";
                                        }
                                    ?>
                                </div>
...
setInterval(function(){
    $("#parking1").load("parking_space1.php #parking1");
}, 5000);
</script>
