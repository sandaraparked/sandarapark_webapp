...
<head>
    ...
    <title>RESPARKMAN - Edit Security Profile Information</title>
    ...
    <div class="container2">
        <div class="forms">
            <div class="form-content">
                ...
                <form action="includes/edit_profile_security.inc.php" method="POST">
                                    ...
                                    <div class="input-box1 col-sm-3">
                                    <input type="hidden" name="email" value="sandarapark@resparkman.com">
                                    </div>
                                    <div class="input-box1 col-sm-3">
                                    ...
                                    <div class="input-box1 col-sm-3">
                                        <input type="hidden" name="plate_num" value="A0B1C2">
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="button input-box">
                                            <input type="submit" name="update_profile-security" value="Update Profile">
                                        </div>
                                    </div>
                </div>
            </div>
