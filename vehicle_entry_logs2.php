            ...
            <div class="container2">
                <div class="forms">
                    <div class="form-content">
                        ...
                        <form action="includes/vehicle_entry_logs.inc.php" method="POST">
                        ...
                        <div class="input-container">
                            <a class="add-btn link-light nounderline" href="includes/vel_export_data.inc.php">Export Data</a>
                            </div>
                        </form>
                        </form>
                        <div class="table-responsive">
                            <table class="styled-table">
                                ...
                                <tbody>
                                    <?php
                                    include('includes/vehicle_entry_logs.inc.php');
                        ...
                        <div class="container4">
                            ...
                            for ($page=1;$page<=$number_of_pages;$page++) {
                                echo '<a href="vehicle_entry_logs2.php?page=' . $page . '">' . $page . '</a> ';
                            }
                            ?>
                            </div>
                        </div>
