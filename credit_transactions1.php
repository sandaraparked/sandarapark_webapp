                    ...
                    <div class="form-content">
                        ...
                        if (isset($_GET["error"])) {
                            if ($_GET["error"] == "date1Required") {
                                ...
                                header('location:credit_transactions1.php');
                            }
                        ...
                        <div class="input-container">
                            <label for="date1">Transaction Date (from):</label>
                            <input class="datepicker form-control" type="text" type="date" id="date1" name="date1" placeholder="yyyy/mm/dd">
                        </div>                
                        <div class="input-container">
                            <label for="date2">Transaction Date (to):</label>
                            <input class="datepicker form-control" type="text" type="date" id="date2" name="date2" placeholder="yyyy/mm/dd">
                        </div>
                        <div class="input-container">
                        ...
                        <div class="table-responsive">
                            <table class="styled-table">
                                ...
                                <tbody>
                                    <?php
                                    require_once 'includes/credit_transactions.inc.php';
