...
<head>
    ...
    <title>RESPARKMAN - Edit Accounting Profile Information</title>
                ...
                <?php
                    ...
                    if (isset($_GET["error"])) {
                        ...
                        elseif ($_GET["error"] == "none") {
                            ...
                            header('location:profile-accounting.php');
                        }
                    }
                ?>
                <div class="input-boxes1">
                <form action="includes/edit_profile_accounting.inc.php" method="POST">
                                    <input type="hidden" name="user_id" value="<?=$_SESSION["user_id"]?>">
                                    <input type="hidden" name="plate_num" value="<?=$_SESSION["plate_num"];?>">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="button input-box">
                                            <input type="submit" name="update_profile-accounting" value="Update Profile">
                                        </div>
                                    </div>
                </div>
            </div>
